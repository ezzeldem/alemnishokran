  ...
  var tmp,
    ...
    _process_inline = function () {
      ...
      if (w.toString().indexOf("%") > -1) {
        w =
          parseInt(
            (($(window).width() - selectedOpts.margin * 2) * parseFloat(w)) /
              100,
            10
          ) + "px";
      } else {
      ...
      if (h.toString().indexOf("%") > -1) {
        h =
          parseInt(
            (($(window).height() - selectedOpts.margin * 2) * parseFloat(h)) /
              100,
            10
          ) + "px";
      } else {
    ...
    _show = function () {
      ...
      if (
        wrap.is(":visible") &&
        false === currentOpts.onCleanup(currentArray, currentIndex, currentOpts)
      ) {
          ...
          content
            ...
            .css({
              ...
              height: selectedOpts.autoDimensions
                ? "auto"
                : final_pos.height - titleHeight - currentOpts.padding * 2,
            });
    ...
    _get_zoom_to = function () {
      ...
      if (currentOpts.width.toString().indexOf("%") > -1) {
        to.width = parseInt(
          (view[0] * parseFloat(currentOpts.width)) / 100,
          10
        );
      } else {
      ...
      if (currentOpts.height.toString().indexOf("%") > -1) {
        to.height = parseInt(
          (view[1] * parseFloat(currentOpts.height)) / 100,
          10
        );
      } else {
      ...
      to.top = parseInt(
        Math.max(view[3] - 20, view[3] + (view[1] - to.height - 40) * 0.5),
        10
      );
      to.left = parseInt(
        Math.max(view[2] - 20, view[2] + (view[0] - to.width - 40) * 0.5),
        10
      );
